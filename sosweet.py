...
def is_wcw(status):
    ...
    usernames = ['sosweetbot', 'JustToSayBot', 'thatisjustplums', 'EatenBot', 'the_niche_bot', 'KristenCostel10', 'litabottal', 'pythonnina', 'alatest5', 'LisaRob96585017','Stilson28400122', 'JohnDun40217560','Cordelia28', 'Rick63556459'] # Block screen_names of known parody accounts
